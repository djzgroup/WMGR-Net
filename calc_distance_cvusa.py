...
df_train = pd.read_csv('F:\locatication数据集\CVPR_subset\splits/train-19zl.csv', header=None)
...
df_gps = pd.read_csv('F:\locatication数据集\CVPR_subset/split_locations/all.csv', header=None)
...
print("Saving...") 
with open("F:\locatication数据集/CVPR_subset/gps_dict.pkl", "wb") as f:
