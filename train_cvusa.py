...
from WMGR_Net.dataset.cvusa_weather import CVUSADatasetEval, CVUSADatasetTrain
...
class Configuration:
    ...
    gps_dict_path: str = "/smalldata/CVPR_subset/CVPR_subset/gps_dict.pkl"  # path to pre-computed distances
    ...
    # Dataset
    data_folder = "/smalldata/CVPR_subset/CVPR_subset"
